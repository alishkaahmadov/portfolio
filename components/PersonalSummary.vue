<template>
    <div class="font-poppins flex flex-col justify-center items-center py-40 px-30">
        <img src="/images/me.svg" alt="Me">
        <h1 class="font-bold text-5xl text-[#484E53] py-4">Ali Ahmadov</h1>
        <h2 class="font-semibold text-2xl bg-gradient-to-r from-[#4FC3F7] to-[#484E53] bg-clip-text text-transparent pb-4">Web Developer</h2>
